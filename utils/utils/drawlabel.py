...
file = "/home/jdhl/WorkSpace/ZOUZHEN/dataset/7-29/stream"

# 添加标签后的数据路径
save_file="/home/jdhl/WorkSpace/ZOUZHEN/dataset/8-5/result"

files = os.listdir(file)
# 标注文件路径
label_path = "/home/jdhl/WorkSpace/ZOUZHEN/dataset/8-5/taotal.txt"
